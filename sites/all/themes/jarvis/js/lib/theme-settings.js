...
jQuery(function($){
    ...
    function changeHeaderBgType(obj,headerBackgroundType) {
        if(headerBackgroundType == 'callout-text') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").show();
			obj.find("#header-static-bg-wrapper").show();
			obj.find("#header-image-wrapper").hide();
			obj.find("#header-video-code-wrapper").hide();
        }
         if(headerBackgroundType == 'callout-text-2') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").show();
			obj.find("#header-static-bg-wrapper").show();
			obj.find("#header-image-wrapper").hide();
         ...
         if(headerBackgroundType == 'text-slider') {
            obj.find("#header-video-wrapper").show();
            obj.find("#header-text-wrapper").hide();
			obj.find("#header-static-bg-wrapper").show();
			obj.find("#header-image-wrapper").hide();
			obj.find("#header-video-code-wrapper").hide();
        }
		 if(headerBackgroundType == 'bg-image-slider') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").show();
			obj.find("#header-static-bg-wrapper").hide();
			obj.find("#header-image-wrapper").show();
			obj.find("#header-video-code-wrapper").hide();
        }
		 if(headerBackgroundType == 'full-slider') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").hide();
			obj.find("#header-static-bg-wrapper").hide();
			obj.find("#header-image-wrapper").show();
		 ...
		 if(headerBackgroundType == 'circle-quote') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").show();
			obj.find("#header-static-bg-wrapper").show();
			obj.find("#header-image-wrapper").hide();
		 ...
		 if(headerBackgroundType == 'vimeo') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").show();
			obj.find("#header-static-bg-wrapper").hide();
			obj.find("#header-image-wrapper").hide();
			obj.find("#header-video-code-wrapper").show();
        }
		 if(headerBackgroundType == 'youtube') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").show();
			obj.find("#header-static-bg-wrapper").hide();
			obj.find("#header-image-wrapper").hide();
		 ...
		 if(headerBackgroundType == 'simplenews') {
            obj.find("#header-video-wrapper").hide();
            obj.find("#header-text-wrapper").hide();
			obj.find("#header-static-bg-wrapper").hide();
			obj.find("#header-image-wrapper").hide();
	...
	//$('input#edit-skin-color').before('<span id="backgroundcolorselect" class="colorSelect2"><span></span></span>');
	...
	filestyle("#edit-design-static-bg-upload", '.form-item-files-design-static-bg-upload', '.form-item-design-static-bg-path');
	filestyle("#edit-map-marker-upload", '.form-item-files-map-marker-upload', '.form-item-map-marker-path');
	filestyle("#edit-map-logo-upload", '.form-item-files-map-logo-upload', '.form-item-map-logo-path');
    for(var i=1;i<=7;i++) {
