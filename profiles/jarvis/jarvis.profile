 ...
 */
function jarvis_form_install_configure_form_alter(&$form, $form_state) {
  // Pre-populate the site name with the server name.
  $form['site_information']['site_name']['#default_value'] = $_SERVER['SERVER_NAME'];
  $form['#submit'][] = 'jarvis_form_submit';
}


function jarvis_form_submit($form, &$form_state) {
  // Import database jarvis file.
  $jarvis_file = dirname(__FILE__) . '/jarvis.sql';
  $success = import_jarvis($jarvis_file);
 ...
 * @see demo_reset().
 */
function import_jarvis($filename) {
